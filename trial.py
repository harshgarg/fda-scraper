...
for district in option_values_district:
  ...
  for taluka in option_values_taluka:
    ...
    if EC.alert_is_present()(driver):
      ...
      for first_letter in range(0,9):
        for second_letter in range(0,9):
          for third_letter in range(0,9):
            search_word = ""
            search_word = str(first_letter) + str(second_letter) + str(third_letter)
